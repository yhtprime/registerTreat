<template>
    <div class="index">
        <div class="swi">
            <mt-swipe :auto="4000">
                <mt-swipe-item><img src="/static/img/h1.jpg"></mt-swipe-item>
                <mt-swipe-item><img src="/static/img/h1.jpg"></mt-swipe-item>
                <mt-swipe-item><img src="/static/img/h1.jpg"></mt-swipe-item>
            </mt-swipe>
        </div>
        <div class="textbody">
            <div class="top4">
                <div @click="bingyou"><img src="/static/img/byq.jpg"><p>病友圈</p></div>
        ...
        <div class="textbody">
            ...
            <div v-for="(item) in newlist" :key="item.npic" @click="skipb(item.nid)" class="consult">
                <div class="citem">
                    <div class="item_pic"><img :src="'http://dryht.cn/registerTP/public/static/'+item.npic"></div>
                    <div class="item_text">
...
export default {
    ...
    methods:{
        bingyou(){
            this.$router.push('/footer',{jump:2});            
